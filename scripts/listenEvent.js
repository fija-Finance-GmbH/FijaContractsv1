const Strategy = require("../artifacts/contracts/ethereum/v3EventBackend/strategy.sol/FijaStrategyEvent.json")
...
const main = async () => {
  ...
  LiquidityExamples = await ethers.getContractFactory("LiquidityCompleteEvent")
