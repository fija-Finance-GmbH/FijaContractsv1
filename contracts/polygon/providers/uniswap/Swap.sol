...
contract Swap {
    ...
    function swapExactInputSingle(uint amountIn, uint amountMinOut, address _tokenIn, address _tokenOut, uint24 poolFee)
        external
        returns (uint amountOut)
    {
        ...
        .ExactInputSingleParams({
            ...
            amountIn: amountIn,
            //@audit add amount out minimmum
            amountOutMinimum: amountMinOut,
            // NOTE: In production, this value can be used to set the limit
            // for the price the swap will push the pool to,
            // which can help protect against price impact
            //@audit check how to solve it
            sqrtPriceLimitX96: 0
        });
        amountOut = swapRouter.exactInputSingle(params);
    }

//@audit from here down bellow not used
    ...
    /// swap WETH --> USDC --> DAI
    //@audit FROM HER BELOW ARE UNUSED FUNCTIONS
